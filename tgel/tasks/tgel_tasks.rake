...
#        system "xcopy vendor\\plugins\\tgel\\app\\models app\\models /y/e"
        system "xcopy vendor\\plugins\\tgel\\public\\index.mm . /y/e"
        system "xcopy vendor\\plugins\\tgel\\public\\routes.rb config"
#        system "xcopy vendor\\plugins\\tgel\\template\\application_helper.rb app\\helpers /y/e"
        system "xcopy vendor\\plugins\\tgel\\app\\controllers\\application_controller.rb app\\controllers /y/e"
        system "xcopy vendor\\plugins\\tgel\\app\\views\\layouts\\application.haml app\\views\\layouts /y/e"
        system "xcopy vendor\\plugins\\tgel\\public\\index.haml app\\views\\welcome /y/e"
        system "xcopy vendor\\plugins\\tgel\\start.bat ./y/e"
      else
...
#        system "cp vendor/plugins/tgel/template/application_helper.rb app/helpers"
